          ...
          <div class="col-xs-7 col-sm-12">
            ...
            <div class="row">
              <?if(strlen($item['VIDEO'])>0):?>
                <div class="col-xs-6 col-lg-5"><a data-toggle="modal" data-target="#techMedia" href="#techMedia" class="tech__link tech__video"  data-url="<?=$item['DETAIL_PAGE_URL']?>?a=video"><?=svg('video')?>Видео</a></div>
              <?endif;?>
              <?if(count($item['IMAGES'])>0):?>
                <div class="col-xs-6 col-lg-7"><a data-toggle="modal" data-target="#techMedia" href="#techMedia" class="tech__link tech__photos"  data-url="<?=$item['DETAIL_PAGE_URL']?>?a=photo"><?=svg('photos')?>Фотогалерея</a></div>
              <?endif;?>
            </div>
          </div>
        </div>
